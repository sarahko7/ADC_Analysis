...
# since sample size is small, and totals of all types was non-normal, will use non-parametric test for changepoint analysis
...
##SKO save figures
ggsave("CD_plot_changepoints.pdf", CD_plot_changepoints, path = "../Output/CD_plot_changepoints.pdf")
