...
# assumptions for lm (independent observation, normal distribution, equal variances among groups) checked in Test 1
# data is not normal, but bc group variances are equal
...
CD_plot_changepoints <- ggplot(CD_only, aes(x=Quarter.End.Date, y=Construction.and.Demolition.Waste)) +
  geom_point() +
  geom_vline(aes(xintercept=as.Date('2008-02-14')), linetype=2, colour="red", size=1) +
  geom_vline(aes(xintercept=as.Date('2015-02-14')), linetype=4, colour="blue", size=1) + 
  geom_text(x=as.Date('2009-09-1'), y=260000, label=stringr::str_wrap('breakpoint1: Q4,2007-Q1,2008', 15), colour="red", size=5) +
  geom_text(x=as.Date('2016-09-1'), y=260000, label=stringr::str_wrap('breakpoint2: Q4,2014-Q1,2015', 15), colour="blue", size=5) +
  xlab('End of Report Quarter') + 
  ylab('C&D Cover (U.S. Tons)') + 
  scale_y_continuous(labels = scales::comma) + 
  ggtitle('Construction & Demolition Daily Cover in CA')
...
CD_plot_changepoints <- ggplot(CD_only, aes(x=Quarter.End.Date, y=Construction.and.Demolition.Waste)) +
  geom_point() +
  geom_vline(aes(xintercept=as.numeric(Quarter.End.Date[c(40)])), linetype=2, colour="blue", size=1) +
  geom_vline(aes(xintercept=as.numeric(Quarter.End.Date[c(68)])), linetype=2, colour="blue", size=1) + 
  xlab('End of Report Quarter') + 
  ylab('C&D Cover (U.S. Tons)') + 
  scale_y_continuous(labels = scales::comma) + 
  ggtitle('Construction & Demolition Daily Cover in CA')
print(CD_plot_changepoints)  
##SKO: add dates as text
##check LEED
